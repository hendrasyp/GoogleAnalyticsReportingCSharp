...
namespace GAnalyticsAPI.Models
{
    public class ReportManager
    {
        ...
        {
            string filepath = HttpContext.Current.Server.MapPath("~/lcdi-3007db40d763.json");
            var analyticsService = GetAnalyticsReportingServiceInstance(filepath);
